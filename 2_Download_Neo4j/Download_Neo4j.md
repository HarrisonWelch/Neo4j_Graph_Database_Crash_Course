...
![Image of legal stuff](image.png)

Choose install location

![Choose install location](image-1.png)

Paste in the key

May need to download the runtime, check keys

Home screen

![After install screenshot](image-3.png)

Kick or Keep the example "movie" DB

Create new project for "NBA"
...
![Start the DB](image-7.png)

![DB](image-8.png)

system and default DB
* Default DB is where we want to put stuff
...
Click the DB icon and we can see in (2) that our DB is connected and we are quierying to it.
...
Got to github and pulle this ".cypher" file

Link: https://github.com/harblaith7/Neo4j-Crash-Course/blob/main/01-initial-data.cypher
...
Copy Paste that in and run

Should look a bit like this

![DB example after run create](image-12.png)
